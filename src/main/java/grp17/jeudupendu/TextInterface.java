...
public class TextInterface {
    ...
    /**
     * Méthode qui permet de demander à l'utilisateur si il veut jouer seul
     * contre l'ordinateur ou à 2
     *
    ...
    /**
     * Méthode qui permet d'afficher le message de fin de partie, selon la
    ...
    /**
     * Méthode qui permet de choisir le mot à deviner Si la partie se joue à un
     * joueur, on le tire aléatoirement d'un dictionnaire, si la partie se joue
     * à 2 joueurs, c'est un des deux joueurs qui choisit le mot
     *
